...
export function Contact() {
  ...
  const details: Detail[] = [
    ...
    },
    {
      icon: FaGithub,
      label: "GitHub",
      value: profile.github.replace("https://www.", "").replace("https://", ""),
      href: profile.github,
    },
  ];
              ...
              const body = (
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-xs uppercase tracking-wider opacity-60">{d.label}</p>
        ...
        >
          ...
          >
            {isSubmitting ? (
              <>
                <svg
                  className="animate-spin -ml-1 mr-3 h-5 w-5 text-brand-foreground"
